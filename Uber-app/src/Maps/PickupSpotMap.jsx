...
const MapComponent = () => {
  ...
  const itemImage = searchParams.get('img');
  const itemPrice = searchParams.get('price');
  const itemDesc = searchParams.get('desc');
  ...
  const handelCheckout = async ()=>{
    const stripe = await loadStripe("pk_test_51Pu9NVCR7xdE1BYxr5TAqmqkdTxgjSypa3TMTLSPl7B9kzYaBx8R4y9pPeojKpL4LeNvWh0wvoPBai56ctVlS5ON00dYQggBQi");
    ...
    <div style={{ position: "relative", height: "70vh" }}>
      ...
      >
        <span className=" flex flex-col items-center">
          <h2 className=" px-5 py-1 rounded-xl bg-black text-white text-lg font-semibold">
            PickUp here
          </h2>
      ...
      <div className="w-full flex flex-col justify-between p-4">
        ...
        <button
          ...
          className="flex-1 mt-8 w-full py-3 bg-black text-white text-2xl font-semibold rounded-xl text-center"
        >
          Confirm Pickup
        </button>
      </div>
